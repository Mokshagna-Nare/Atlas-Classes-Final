...
const AdminDashboard: React.FC = () => {
  ...
  const renderContent = () => {
    switch (activeView) {
      ...
      case 'paper-generator':
        return <QuestionPaperGenerator />; // -- NEW ROUTE --
      case 'institutes':
  ...
  return (
    <div className="min-h-screen flex bg-atlas-dark text-white font-sans">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 bg-atlas-soft border-r border-gray-800 p-4 flex flex-col z-30 w-64 transform transition-transform duration-300 ease-in-out md:relative md:translate-x-0 ${
