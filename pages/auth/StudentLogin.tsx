    ...
    <div className="min-h-screen bg-atlas-dark flex items-center justify-center">
      <div className="bg-atlas-soft p-8 rounded-lg shadow-2xl w-full max-w-md border border-gray-800">
        <div className="text-center mb-6">
            ...
            />
            <h2 className="text-3xl font-bold text-atlas-green">Student Login</h2>
        </div>
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              placeholder="e.g., student@atlas.com"
              required
            />
          </div>
          <div>
         ...
         <p className="text-center text-gray-500 mt-4 text-sm">
            Institute? <Link to="/login/institute" className="text-atlas-green hover:underline font-medium">Login here</Link>
        </p>
